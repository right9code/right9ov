...
```bash
sudo pacman -S btop wget curl eza yazi fzf iwd wireless_tools tldr ncdu zoxide nethogs noto-fonts-emoji fastfetch libnotify android-tools ripgrep 7zip zip unzip fastfetch rsync auto-cpufreq --needed
```
`25 MiB`
