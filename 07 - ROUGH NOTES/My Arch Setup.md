...
```bash
sudo pacman -S btop wget curl eza yazi fzf iwd wireless_tools tldr ncdu zoxide nethogs noto-fonts-emoji fastfetch libnotify android-tools ripgrep udiskie 7zip zip unzip fastfetch --needed
```
`25 MiB`
