...
**Uttarakhand Special Subordinate Education (Lecturer’s Cadre Service)**  
*(General and Female Branch)*  

## Subject-wise Syllabus for Uttarakhand Lecturer Exam – Objective Type  
Syllabus for Uttarakhand
A written exam will be conducted for the subject opted by the candidate. The question paper will be **multiple-choice (objective type)**.

| S. No. | Paper    | No. of Questions | Maximum Marks | Duration |
| ------ | -------- | ---------------- | ------------- | -------- |
| 1      | Paper I  | 150              | 150           | 3 Hours  |
| 2      | Paper II | 150              | 150           | 3 Hours  |

### Important Notes:
- **Negative Marking**:  
  - **¼ (one-fourth)** mark will be deducted for each **wrong answer**.  
  - **¼ (one-fourth)** mark will also be deducted if **more than one option** is marked for a single question—even if one of the answers is correct.  
- **Final Merit List**: Based solely on performance in the written exam.  
- Candidates must choose a subject **from the list provided**, as per their educational qualification.

---

## Subject List (Excerpt)
| S. No. | Subject   |
|--------|-----------|
| 16     | English   |
